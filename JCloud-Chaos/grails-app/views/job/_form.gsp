...
<div class="fieldcontain ${hasErrors(bean: jobInstance, field: 'name', 'error')} required">
	<label for="name">
		<g:message class="control-label"code="job.name.label" default="Name" />
...
<div class="fieldcontain ${hasErrors(bean: jobInstance, field: 'jcloudsUrl', 'error')} required">
	<label for="jcloudsUrl">
		<g:message class="control-label"code="job.jcloudsUrl.label" default="Jclouds Url" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: jobInstance, field: 'provider', 'error')} required">
	<label for="provider">
		<g:message class="control-label"code="job.provider.label" default="Provider" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: jobInstance, field: 'user', 'error')} required">
	<label for="user">
		<g:message class="control-label"code="job.user.label" default="User" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: jobInstance, field: 'key', 'error')} required">
	<label for="key">
		<g:message class="control-label"code="job.key.label" default="Key" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: jobInstance, field: 'numberOfInstancesToDestroy', 'error')} required">
	<label for="key">
		<g:message class="control-label"code="job.numberOfInstancesToDestroy.label" default="No. Instances To Destroy" />
		<span class="required-indicator">*</span>
	</label>
